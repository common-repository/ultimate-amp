...
if ( is_plugin_active( 'elementor/elementor.php' ) ) {    
    jewel_ultimate_amp_admin_notice_requires();
}

function jewel_ultimate_amp_admin_notice_requires(){
	
	include( plugin_dir_path( __FILE__ ) . 'class-tgm-plugin-activation.php');

	add_action( 'tgmpa_register', 'jewel_ultimate_amp_register_required_plugins' );
}



function jewel_ultimate_amp_register_required_plugins(){
